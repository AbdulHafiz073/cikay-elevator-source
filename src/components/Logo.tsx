...
export function Logo({ size = 48 }: { size?: number }) {
  return (
    <div className="flex items-center gap-3">
      ...
      >
        <div className="grid h-full w-full place-items-center rounded-[4px] bg-background">
          <span
            className="gold-text font-display font-bold leading-none"
            style={{ fontSize: size * 0.42 }}
          >
            <img src="/src/components/public/image/Cikay-logo1.jpeg"  className="object-cover rounded-[10%] "
  style={{
    width: size,
    height: size * 0.9 }} />
          </span>
